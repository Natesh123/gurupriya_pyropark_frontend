    ...
    return (
        <div className={`fixed ${bottomClass} right-4 sm:right-6 z-[90] flex flex-col gap-3 sm:gap-4 transition-all duration-500 animate-slideDown`}>
            ...
            >
                ...
                />
                <span className="absolute right-full mr-4 bg-white text-black text-sm font-semibold px-4 py-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity shadow-lg whitespace-nowrap">
                    Chat on WhatsApp
                </span>
            </a>
