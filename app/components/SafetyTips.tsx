...
export default function SafetyTips() {
    return (
        <section id="safety-tips" className="bg-slate-50 pt-8 pb-12 md:pt-12 md:pb-16 scroll-mt-24 relative overflow-hidden">
            ...
            {/* Sparkles Background */}
            <div className="absolute top-20 left-[10%] text-amber-500/40 text-xl animate-[pulse_3s_infinite]">✨</div>
            <div className="absolute top-40 right-[20%] text-emerald-500/40 text-xl animate-[pulse_2s_infinite]">✨</div>
            <div className="absolute bottom-40 left-[20%] text-amber-500/30 text-xl animate-[pulse_4s_infinite]">✨</div>
            ...
            <div className="container mx-auto px-4 lg:px-8 relative z-10 max-w-7xl">
                ...
                <div className="text-center mb-16 md:mb-28">
                    <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-white border border-emerald-200 text-emerald-600 font-semibold uppercase tracking-[0.3em] text-xs md:text-sm mb-6 shadow-sm">
                        <span className="w-2 h-2 rounded-full bg-emerald-500 animate-ping"></span>
                        Premium Safety Protocol
                    </div>
                    <h2 className="text-xl md:text-xl lg:text-xl font-semibold text-slate-900 mb-6 tracking-tighter drop-shadow-sm leading-[1.2]">
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center text-center">
                                    {/* Icon Container */}
                                    <div className="w-20 h-20 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-center text-xl mb-6 shadow-sm group-hover:scale-110 group-hover:border-emerald-200 group-hover:bg-white transition-all duration-500">
                                        {tip.icon}
                                    </div>
                                    
                                    <h3 className="text-xl font-semibold text-slate-900 mb-4 tracking-wide group-hover:text-emerald-700 transition-colors duration-300">
                                        {tip.title}
                                    </h3>
                ...
                <div className="mt-12 md:mt-24">
                    <div className="relative rounded-[2.5rem] bg-white p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl border border-red-100 group overflow-hidden">
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6 relative z-10 text-center md:text-left w-full">
                            <div className="shrink-0 w-20 h-20 rounded-full bg-red-100 border-[2px] border-red-200 flex items-center justify-center text-xl shadow-sm animate-pulse">
                                🚨
                            </div>
                            
                            <div>
                                <h4 className="text-xl md:text-xl font-semibold text-red-950 mb-2 uppercase tracking-wider">Emergency Protocol</h4>
