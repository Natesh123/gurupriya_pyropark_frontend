...
export default function FireworkGallery() {
    return (
        <section className="bg-gradient-to-b from-white via-slate-50 to-white pt-8 pb-24 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-16 relative">
                    <span className="text-emerald-600 text-sm font-semibold tracking-[0.4em] uppercase mb-4 block drop-shadow-sm">Visual Experience</span>
                    <h2 className="text-xl md:text-xl font-semibold text-slate-900 mb-6 uppercase tracking-tighter">
                    ...
                    {galleryImages.map((img) => (
                        ...
                        >
                            ...
                            <div className="px-2 flex flex-col items-center text-center pb-2">
                                <span className="inline-block px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 border border-emerald-100 text-[10px] font-semibold uppercase tracking-wider mb-3">
                                    {img.tag}
                                </span>
                                <h3 className="text-xl font-semibold text-slate-800 uppercase tracking-tight group-hover:text-emerald-600 transition-colors duration-300">
                                    {img.title}
                                </h3>
                            </div>
                        </div>
                ...
                <div className="mt-20 max-w-fit mx-auto p-[2px] bg-gradient-to-r from-emerald-200 via-amber-300 to-emerald-200 rounded-full shadow-lg">
                     <div className="bg-white py-4 px-8 md:px-12 text-center rounded-full">
                        <p className="text-slate-700 text-xs md:text-sm font-semibold uppercase tracking-[0.3em] md:tracking-[0.5em]">
