...
export default function FloatingCart() {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-[100] lg:hidden animate-[slideUp_0.4s_ease-out]">
      <div className="bg-gradient-to-r from-emerald-500 to-emerald-600 text-white p-3.5 pb-safe flex items-center justify-between shadow-[0_-8px_25px_rgba(0,0,0,0.6)] border-t-[1.5px] border-festive-gold/40">
        <div className="flex flex-col ml-1">
          <span className="text-white/80 text-[10px] font-bold uppercase tracking-wider mb-0.5">
        ...
        >
          View Cart 
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-emerald-700">
